...
//		 	String name = request.getParameter(namePart.getName());
//		 	String title = request.getParameter(titlePart.getName());
			...
			out.println("파일 개수 : " + parts.size() + "<br>");
			int count = 0;
			for( Part part : parts ) {
