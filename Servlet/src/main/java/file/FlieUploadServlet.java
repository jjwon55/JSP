...
@MultipartConfig(
	fileSizeThreshold = 1 * 1024 * 1024, 	//파일 초과ㅣ시 임시 메모리
	maxFileSize = 10 * 1024 * 1024,			// 10MB 파일당 최대 크기
	maxRequestSize = 50 * 1024 * 1024		// 50MB 요청당 최대 크기
)

public class FlieUploadServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 파일 이름
		String fileName = Paths.get(filePart.getSubmittedFileName())		// name="file"
